        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">Strength Compass</span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Empowering athletes with data-driven insights for equitable strength training. 
              Predict your potential, track your progress, and overcome barriers together.
            </p>
            <div className="flex space-x-4">
              ...
              <a
                href="mailto:contact@strengthcompass.com"
                className="text-gray-400 hover:text-white transition-colors"
                aria-label="Email"
              >
